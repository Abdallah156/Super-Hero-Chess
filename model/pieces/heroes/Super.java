...
public class Super extends ActivatablePowerHero {
	...
	public void moveDownRight() throws UnallowedMovementException {
		throw new UnallowedMovementException("Unallowed movement direction",this, Direction.DOWNRIGHT);
	}

	@Override
	public void moveDownLeft() throws UnallowedMovementException {
		throw new UnallowedMovementException("Unallowed movement direction",this, Direction.DOWNLEFT);
	}
	...
	public String toString() {
		if(this.isPowerUsed() == false)
			return "<html> Super" + "<br>" + " Power is not used " + "<br>" + "Owner:" +this.getOwner().getName()+ "</html>";
		return "<html> Super" + "<br>" + " Power is used " + "<br>" + "Owner:" +this.getOwner().getName() + "</html>";
	}
}
