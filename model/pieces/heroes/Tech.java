...
public class Tech extends ActivatablePowerHero {
	...
	public void moveDown() throws UnallowedMovementException {
		throw new UnallowedMovementException("Unallowed movement direction",this, Direction.DOWN);
	}

	@Override
	public void moveRight() throws UnallowedMovementException {
		throw new UnallowedMovementException("Unallowed movement direction",this, Direction.RIGHT);
	}

	@Override
	public void moveLeft() throws UnallowedMovementException {
		throw new UnallowedMovementException("Unallowed movement direction",this, Direction.LEFT);
	}
	...
	public String toString() {
		if(this.isPowerUsed() == false)
			return "<html> Tech" + "<br>" + " Power is not used " + "<br>" + "Owner:" +this.getOwner().getName() + "</html>";
		return "<html> Tech" + "<br>" + " Power is used " + "<br>" + "Owner:" +this.getOwner().getName() +"</html>";
	}
}
