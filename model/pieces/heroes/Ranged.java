...
public class Ranged extends ActivatablePowerHero {
		...
		if (hit != null) {
			if (hit.getOwner() != getOwner()) {
				...
				throw new InvalidPowerDirectionException("Using "
						...
						+ " will result in hitting a freindly piece", this, d);
			}
		} else {
	...
	public String toString() {
		if(this.isPowerUsed() == false)
			return "<html> Ranged" + "<br>" + " Power is not used " + "<br>" + "Owner:" +this.getOwner().getName()+"</html>";
		return "<html> Ranged" + "<br>" + " Power is used " + "<br>" + "Owner:" +this.getOwner().getName()+"</html>";
	}
}
